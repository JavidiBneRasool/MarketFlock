...
def run():
    ...
    ping_google_sitemap("https://marketflock.cutbar.in/sitemap.xml")
    ping_google_sitemap("https://marketflock.cutbar.in/news-sitemap.xml")
...
def _run_api_indexing():
    ...
    for article in articles:
        ...
        url = f"https://marketflock.cutbar.in/{filename}"
